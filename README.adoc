...
== Quick Start
  ...
  $ java -jar rsqueezea-cli/build/libs/rsqueezea-cli-1.0.0-SNAPSHOT.jar --help
...
$ java -jar rsqueezea-cli/build/libs/rsqueezea-cli-1.0.0-SNAPSHOT.jar squeeze \
...
....
$ java -jar rsqueezea-cli/build/libs/rsqueezea-cli-1.0.0-SNAPSHOT.jar reassemble \
